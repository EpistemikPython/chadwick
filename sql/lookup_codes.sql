...
CREATE TABLE 'lkup_cd_bases' (
  ...
  KEY 'VALUE_CD' ('VALUE_CD','LONGNAME_TX')
);
...
insert  into 'lkup_cd_hit'('VALUE_CD','SHORTNAME_TX','LONGNAME_TX','DESCRIPTION_TX') values (1,'1B','Single',NULL),(2,'2B','Double',NULL),(3,'3B','Triple',NULL),(4,'HR','Homerun',NULL);
